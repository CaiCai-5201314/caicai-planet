      ...
      <div className="pt-20 pb-12">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h1 className="text-3xl font-bold text-gray-900 mb-4">星际传送门</h1>
            <p className="text-gray-600 max-w-2xl mx-auto">
              这里是菜菜星球的友好链接，欢迎与我们交换星际传送门，共同成长
            </p>
          </div>
          ...
          <div className="mt-16 bg-white rounded-2xl shadow-sm border border-gray-100 p-8 text-center">
            <h3 className="text-xl font-bold text-gray-900 mb-4">申请星际传送门</h3>
            <p className="text-gray-600 mb-6">
              如果您希望与菜菜星球交换星际传送门，请联系我们的管理员
            </p>
            <p className="text-gray-500 text-sm">
              星际传送门要求：内容健康，积极向上，与技术或生活相关
            </p>
          </div>
        </div>
      </div>
