  ...
  if (!taskType) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        <div className="pt-24 text-center py-12">
          <div className="text-6xl mb-4">😕</div>
          <h2 className="text-2xl font-bold text-gray-900">任务类型不存在</h2>
          <button
            onClick={() => navigate('/tasks')}
            className="mt-6 px-6 py-2 bg-planet-purple text-white rounded-full font-medium hover:bg-planet-purple/90 transition-colors"
          >
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center mb-8">
            ...
            <div className="flex items-center flex-1 justify-center">
              ...
              <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">{taskType.name}</h1>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-8">
            <p className="text-gray-600">{taskType.description || '暂无描述'}</p>
          </div>
          ...
          <div className="mb-8">
            ...
            {tasks.length > 0 ? (
              ...
              <div className="bg-white rounded-2xl border border-gray-200 p-12 text-center">
                ...
                <p className="text-gray-500 text-lg">暂未发布新任务</p>
